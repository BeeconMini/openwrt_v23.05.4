...
define KernelPackage/sound-soc-stm32-dfsdm
  ...
  FILES:=$(LINUX_DIR)/sound/soc/stm/snd-soc-stm32-fdsdm.ko
  AUTOLOAD:=$(call AutoProbe,snd-soc-stm32-fdsdm)
  $(call AddDepends/sound,@TARGET_stm32 +kmod-sound-soc-core +kmod-stm32-dfsdm-adc)
endef
...
define KernelPackage/stm32-dfsdm-adc
  ...
  FILES:=$(LINUX_DIR)/drivers/iio/adc/stm32-dfsdm-core.ko \
	 $(LINUX_DIR)/drivers/iio/adc/stm32-dfsdm-adc
...
define KernelPackage/nvmem-stm32-romem
  ...
  FILES:=$(LINUX_DIR)/drivers/nvmem/nvmem-stm32-romem.ko
...
define KernelPackage/stm32-cryp
  ...
  $(call AddDepends/crypto,@TARGET_stm32 +kmod-crypto-hash)
endef
